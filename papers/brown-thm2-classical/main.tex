...
it carries no restriction $k\le2H^{2}\log H$: our range is all $k\ge2$. This inequality is the key input of the classical case; the passage from it to the non-negativity of
the corresponding Li coefficients invokes the implication of Brown's Lemma 5, whose proof contains an
unresolved error, so we state the consequence conditionally on that step being repaired.
