...
Batch-4 (F10+F11+F12, 18条): C=0  P1=0  P2=3  P3=0  P4=5  U=10  SPEC=10
             核对 0+3+5+10 = 18 OK;  本批 C=0
             P2={M05,M08,Mt03}  P4={M07,Mt06,Mt07,Mt08,Au02}
             U={M01,M02,M06,Mt04,Mt05,Au03,Au04,Au05,Au07,Au08}  SPEC=U(10行)

全池 (100条): C=7 | S2-30 的 P=17 (未细分) | P2=14 P3=4 P4=17 | U=41 | SPEC 约 20
             恒等式 7+17+14+4+17+41 = 100 OK   (S2 全部跑完)
...
## §7 进度（2026-09-25 更新）
- **C07 = CLOSED**：`t_2[19,9] = 4`（档级）＋ `t_2[20,9] = 4`（机器级自有证书）⟹ 见 `docs/S2-C07-STAGE-REPORT-CLOSED.md`
